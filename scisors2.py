...
def rock():
    ...
    if len(how_many) >= 3:
        # sadze ze zamiiast ponizszego warunku powinien byc warunek
        # choc jednej wygranej w 3 turach poniewaz teraz jest za ciezko wygrac [ how_many.count("W") >= 1 ]
        # mozna dopisac historie ze przeciwnik jest przekonany o swojej nieomylnosci i
